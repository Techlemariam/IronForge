...
const BATTLE_EMOTES = [
  // Taunts (Free)
  {
    name: 'Come At Me',
    category: 'taunt',
    gifPath: '/assets/emotes/taunts/come-at-me.gif',
    unlockLevel: 1,
  },
  {
    name: 'Too Easy',
    category: 'taunt',
    gifPath: '/assets/emotes/taunts/too-easy.gif',
    unlockLevel: 3,
  },
  {
    name: 'Laughing',
    category: 'taunt',
    gifPath: '/assets/emotes/taunts/laughing.gif',
    unlockLevel: 5,
  },
  { name: 'Nope', category: 'taunt', gifPath: '/assets/emotes/taunts/nope.gif', unlockLevel: 8 },
  {
    name: 'Bye Bye',
    category: 'taunt',
    gifPath: '/assets/emotes/taunts/bye-bye.gif',
    unlockLevel: 10,
  },
  ...
  // Flex (Free)
  {
    name: 'Muscle Pose',
    category: 'flex',
    gifPath: '/assets/emotes/flex/muscle-pose.gif',
    unlockLevel: 1,
  },
  {
    name: 'Victory Dance',
    category: 'flex',
    gifPath: '/assets/emotes/flex/victory-dance.gif',
    unlockLevel: 5,
  },
  {
    name: 'Champion',
    category: 'flex',
    gifPath: '/assets/emotes/flex/champion.gif',
    unlockLevel: 15,
  },
  ...
  // Premium
  {
    name: 'Mic Drop',
    category: 'premium',
    gifPath: '/assets/emotes/premium/mic-drop.gif',
    unlockLevel: 1,
    isPremium: true,
  },
  {
    name: 'Crown',
    category: 'premium',
    gifPath: '/assets/emotes/premium/crown.gif',
    unlockLevel: 1,
    isPremium: true,
  },
  {
    name: 'Deal With It',
    category: 'premium',
    gifPath: '/assets/emotes/premium/deal-with-it.gif',
    unlockLevel: 1,
    isPremium: true,
  },
  {
    name: 'Legendary',
    category: 'premium',
    gifPath: '/assets/emotes/premium/legendary.gif',
    unlockLevel: 1,
    isPremium: true,
  },
  {
    name: 'Unstoppable',
    category: 'premium',
    gifPath: '/assets/emotes/premium/unstoppable.gif',
    unlockLevel: 1,
    isPremium: true,
  },
];
