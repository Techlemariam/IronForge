...
CREATE TABLE "User" (
    ...
    "hevyApiKey" TEXT,
    "pocketCastsToken" TEXT,
    "pocketCastsEnabled" BOOLEAN NOT NULL DEFAULT false,
    ...
    "activePath" TEXT DEFAULT 'WARDEN',
    "archetype" "Archetype" NOT NULL DEFAULT 'WARDEN',
    "archetypeSetAt" TIMESTAMP(3),
    "currentMacroCycle" TEXT DEFAULT 'ALPHA',
    "macroCycleStartDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "consecutiveStalls" INTEGER NOT NULL DEFAULT 0,
    "mobilityLevel" TEXT DEFAULT 'NONE',
    "recoveryLevel" TEXT DEFAULT 'NONE',
    "nutritionMode" TEXT DEFAULT 'MAINTENANCE',
...
CREATE TABLE "Titan" (
    ...
    "cardioIndex" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "mrvAdherence" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
    "lastPowerCalcAt" TIMESTAMP(3),
    "currentBuff" JSONB,
...
CREATE TABLE "DuelChallenge" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "duelType" TEXT DEFAULT 'TITAN_VS_TITAN',
    "activityType" TEXT,
    "durationMinutes" INTEGER,
    "targetDistance" DOUBLE PRECISION,
    "wkgTier" DOUBLE PRECISION,
    "challengerDistance" DOUBLE PRECISION DEFAULT 0,
    "defenderDistance" DOUBLE PRECISION DEFAULT 0,
