...
const ITEMS = [
  {
    ...
    type: 'weapon',
    rarity: 'common',
    description: 'Standard issue resistance training equipment.',
    power: 10,
    locked: false,
  },
  {
    name: 'Nano-Fiber Shirt',
    type: 'armor',
    rarity: 'rare',
    description: 'Sweat-wicking polymers with cooling tech.',
    power: 25,
    locked: false,
  },
  {
    ...
    type: 'accessory',
    rarity: 'epic',
    description: 'Advanced biometrics tracking uplink.',
    power: 45,
    locked: false,
  },
  {
    ...
    type: 'armor',
    rarity: 'legendary',
    description: 'Classified prototype. Enhance squat max by 20%.',
    power: 100,
    locked: true,
  },
  {
    ...
    type: 'accessory',
    rarity: 'rare',
    description: 'Optimizes recovery window efficiency.',
    power: 30,
    locked: true,
  },
];
...
const MONSTERS = [
  {
    ...
    type: 'Construct',
    description:
      'A hulking mass of animate iron, powered by a molten core. Its defenses are nearly impenetrable to standard attacks.',
  ...
  },
  {
    ...
    type: 'Demon',
    description:
      'A shadowy entity that feeds on lactic acid. It chases runners until they collapse from exhaustion.',
  ...
  },
  {
    ...
    type: 'Undead',
    description:
      'A fallen warrior who refused to re-rack weights. Now cursed to carry them for eternity.',
...
async function main() {
  ...
  const commonItems = allItems.filter((i) =>
    ['Iron Dumbbell', 'Nano-Fiber Shirt', 'Heart Rate Monitor'].includes(i.name)
  ); // Treat these as starter/unlocked
  ...
  const defeatedMonsters = allMonsters.filter((m) =>
    ['Iron Golem', 'The Plate Hoarder'].includes(m.name)
  );
