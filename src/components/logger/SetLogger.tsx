        ...
        {sets.map((set, idx) => (
          ...
          >
            ...
            <ForgeInput
              type="number"
              value={set.weight || ''}
              onChange={(e) => updateSet(set.id, 'weight', Number.parseFloat(e.target.value))}
            ...
            <ForgeInput
              type="number"
              value={set.reps || ''}
              onChange={(e) => updateSet(set.id, 'reps', Number.parseFloat(e.target.value))}
              className="h-9 text-center"
              placeholder="0"
            />
            <ForgeInput
              type="number"
              value={set.rpe || ''}
              onChange={(e) => updateSet(set.id, 'rpe', Number.parseFloat(e.target.value))}
        ...
        <div className="flex justify-end">
          ...
          >
            {isSaving ? (
              ...
              <>
                <Save className="h-4 w-4" /> Finish Exercise
              </>
            )}
          </Button>
        </div>
