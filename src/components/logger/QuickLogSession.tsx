...
export default function QuickLogSession({
  ...
  async function handleSaveExercise(sets: any[], exercise: Exercise) {
    ...
    if (context) {
      ...
      const vol =
        context.volume[muscle] ||
        Object.values(context.volume).find((v: any) => v.muscleGroup === muscle);
          ...
          {!activeCombatSession && (
            <div className="text-center space-y-2 mb-8">
              ...
              <p className="text-zinc-400 text-sm max-w-sm mx-auto">
                Select an exercise to begin logging. New exercises are added to your library
                automatically.
              </p>
            </div>
          )}
