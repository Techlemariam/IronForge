...
const steps = [
  {
    ...
    description:
      'Log internally or sync from Hevy, Strava, & Garmin. Every rep, step, and calorie is tracked automatically.',
  ...
  },
  {
    ...
    description:
      'Your physical effort converts to XP. Strength gains boost your damage; cardio fuels your stamina.',
  ...
  },
  {
    ...
    description:
      'Battle bosses, duel friends, and climb the Iron Leagues. Your real-world fitness is your only cheat code.',
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            From{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-magma to-orange-400">
              Sweat
            </span>{' '}
            to{' '}
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <div className="relative mb-6">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${step.color} blur-xl opacity-20 group-hover:opacity-40 transition-opacity duration-500`}
                  />
