  ...
  const testimonials = [
    {
      ...
      role: 'Powerlifter',
      quote:
        'IronForge gamified my prep. I hit a 10kg PR on deadlift just to unlock the Obsidian Armor.',
      rating: 5,
    },
    {
      name: 'Sarah J.',
      role: 'Hybrid Athlete',
      quote:
        "The Oracle's advice is scary good. It predicted my fatigue wall two days before I hit it.",
      rating: 5,
    },
    {
      name: 'Marcus T.',
      role: 'CrossFit Coach',
      quote:
        'Finally, an app that understands that training data IS the game. My clients are addicted.',
      rating: 5,
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-md hover:border-magma/30 transition-colors"
            >
