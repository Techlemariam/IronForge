        ...
        <AnimatePresence>
            {item && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        {/* Rays */}
                        <div className={`absolute inset-0 animate-spin-slow opacity-30 bg-gradient-to-t from-current to-transparent bg-[length:200%_200%] ${RARITY_COLORS[item.rarity].split(' ')[1]}`} />
                        ...
                        <div className="z-10 relative">
                            ...
                            >
                                <div className={`w-32 h-32 rounded-full border-4 border-white/20 bg-black/50 flex items-center justify-center shadow-2xl`}>
                                    {/* Simple Icon placeholder */}
                                    <div className={`w-16 h-16 rounded-full bg-current ${RARITY_COLORS[item.rarity].split(' ')[1]}`} />
                                </div>
                            </motion.div>
                        </div>
