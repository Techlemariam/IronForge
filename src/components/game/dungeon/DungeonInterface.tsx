...
const DungeonInterface: React.FC<DungeonInterfaceProps> = ({
    ...
    return (
        <div className={`relative w-full rounded-xl overflow-hidden bg-zinc-950 border-2 border-zinc-800 p-4 ${className}`}>
            ...
            <div className="flex justify-between items-center mb-4 relative z-10">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-[10px] font-bold uppercase text-zinc-500">
                            <span className="bg-red-950 text-red-400 px-1 rounded border border-red-900">Elite Boss</span>
                ...
                <div className="flex gap-2">
                    {buffs.map((buff, i) => (
                        <div key={i} className="w-8 h-8 rounded bg-blue-900/20 border border-blue-500 flex items-center justify-center text-blue-400" title={buff}>
