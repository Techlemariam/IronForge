            ...
            <div className="w-full max-w-5xl bg-zinc-900 border-2 border-yellow-700 rounded-lg overflow-hidden flex flex-col h-[700px] shadow-[0_0_50px_rgba(234,179,8,0.2)]">
                ...
                <div className="flex-1 p-8 overflow-y-auto bg-[url('https://www.transparenttextures.com/patterns/black-scales.png')]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {SHOP_ITEMS.map(item => (
                            <div key={item.id} className="bg-zinc-950 border border-zinc-800 p-6 rounded-lg group hover:border-yellow-600 transition-all duration-300 relative overflow-hidden">
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <div className="text-right">
                                        <span className={`text-xl font-bold font-mono ${gold >= item.cost ? 'text-white' : 'text-red-500'}`}>
                                            {item.cost} G
                                        </span>
                                    </div>
                                </div>
