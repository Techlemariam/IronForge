...
import { type Faction, getPvpRank, getRankTitle } from '@/lib/pvpRanks';
...
export function RankBadge({
  ...
  return (
    <Badge
      variant="outline"
      className={cn(
        'font-bold uppercase tracking-wider relative overflow-hidden group',
        colorClass,
        sizeClasses.badge,
        className
      )}
    >
      ...
      {showRating && (
        <span className="ml-1 opacity-75 relative z-10 font-mono text-[0.7em]"> {rating}</span>
      )}
