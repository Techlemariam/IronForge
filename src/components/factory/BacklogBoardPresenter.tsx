...
import { AlertCircle, CheckCircle2, ClipboardList, Loader2, Play } from 'lucide-react';
          ...
          items.map((item) => (
            ...
            >
              <div className="flex items-center gap-4 flex-1 mr-4">
                <div
                  className={`p-2 rounded-lg ${item.source === 'ROADMAP' ? 'bg-blue-500/10 text-blue-400' : 'bg-orange-500/10 text-orange-400'}`}
                >
                  {item.source === 'ROADMAP' ? (
