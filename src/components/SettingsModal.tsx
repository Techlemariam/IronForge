...
import { X, Save, Database, Key, User, Dumbbell, Cloud, Lightbulb, Upload } from 'lucide-react';
...
const SettingsModal: React.FC<SettingsModalProps> = ({ onClose, onSave, initialSettings }) => {
  ...
  return (
    <>
          ...
          <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="space-y-4 pt-4 border-t border-zinc-800">
              ...
              <button
                ...
                className="flex items-center gap-2 w-full py-3 bg-orange-900/30 border border-orange-700/50 text-orange-400 rounded font-bold uppercase text-xs hover:bg-orange-900/50 transition-colors"
              >
            ...
            <div className="space-y-4 pt-4 border-t border-red-900/50">
              <h3 className="text-red-400 text-xs font-bold uppercase tracking-widest border-b border-red-900/50 pb-2">Danger Zone</h3>
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full py-3 bg-red-900/30 border border-red-700/50 text-red-400 rounded font-bold uppercase text-xs hover:bg-red-900/50 transition-colors"
              >
                Delete Account
              </button>
              <a
                ...
                className="block text-center text-zinc-500 text-xs hover:text-zinc-300 underline"
              >
                Privacy Policy
              </a>
            </div>
      ...
      <HevyImportWizard isOpen={showImportWizard} onClose={() => setShowImportWizard(false)} />
    </>
  );
};
