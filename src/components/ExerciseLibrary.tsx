...
const EXERCISE_DB = [
    { id: 'ex_bench_press', name: 'Bench Press', muscle: 'Chest', equipment: 'Barbell' },
    { id: 'ex_squat', name: 'Barbell Squat', muscle: 'Legs', equipment: 'Barbell' },
    ...
    { id: 'ex_db_curl', name: 'Dumbbell Curl', muscle: 'Biceps', equipment: 'Dumbbell' },
    { id: 'ex_tricep_ext', name: 'Tricep Extension', muscle: 'Triceps', equipment: 'Cable' },
];
                    ...
                    >
                        <div>
                            ...
                            <div className="text-xs text-zinc-500 mt-1 flex gap-2">
                                <span className="bg-zinc-800 px-1.5 py-0.5 rounded">{ex.muscle}</span>
