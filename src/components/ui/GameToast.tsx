...
import { AlertTriangle, Info, Shield, Trophy } from 'lucide-react';
...
export const toast = {
  success: (message: string, options?: any) => {
    ...
    sonnerToast.success(message, {
      ...
      className: 'bg-zinc-900 border-green-900 text-green-100 font-mono tracking-wide',
      ...options,
    });
  },
  error: (message: string, options?: any) => {
    ...
    sonnerToast.error(message, {
      ...
      className: 'bg-zinc-950 border-red-900 text-red-100 font-heading tracking-wider',
      ...options,
    });
  },
