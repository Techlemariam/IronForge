                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="hidden sm:flex flex-col gap-1 min-w-[140px]">
                        <div className="flex items-baseline gap-1.5">
                            <span className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Level {level}</span>
                            <span className="text-xs text-zinc-600 font-mono">{currentXP}/{maxXP}</span>
                        </div>
