  ...
  return (
    <div className="min-h-screen bg-forge-950 text-white p-6 md:p-12 pb-24">
      ...
      <header className="mb-12 border-b border-white/10 pb-8 flex flex-col md:flex-row justify-between items-end gap-6">
        <div>
          <h1 className="text-4xl md:text-5xl font-serif tracking-widest text-shadow-glow mb-2 uppercase">
            The Armory
          </h1>
          <p className="text-forge-muted font-mono text-sm tracking-wide uppercase">
            Equipment & Artifacts
          </p>
