...
export function MobilityStudio() {
  ...
  const filteredExercises = MOBILITY_EXERCISES.filter(
    (e) => selectedRegion === 'ALL' || e.targetRegions.includes(selectedRegion)
  );
        ...
        {activeExercise ? (
          <div className="w-full max-w-lg flex flex-col items-center gap-6 z-10">
            ...
            <div className="flex flex-col items-center gap-4">
              <div
                className={`text-6xl font-mono font-bold ${timerActive ? 'text-white' : 'text-slate-500'}`}
              >
