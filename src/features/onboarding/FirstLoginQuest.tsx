                ...
                <div className="flex flex-col items-center text-center space-y-6">
                    ...
                    >
                        <span className="flex items-center space-x-2">
                            <span>{currentStep.action ? (isLoading ? "Forging Oath..." : "I Swear It") : "Continue"}</span>
                            {!currentStep.action && <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />}
                        </span>
                    </button>
