import type { GarminWellnessData } from '@/services/bio/GarminService';
        ...
        <div>
          <div className="flex items-center gap-1.5 bg-black/40 px-3 py-1.5 rounded-lg border border-white/5">
            ...
            <span
              aria-live="polite"
              aria-atomic="true"
              className="text-2xl font-mono font-bold text-white tabular-nums leading-none"
            >
        ...
        {questTitle && bossHp === undefined && (
          ...
          >
            <div className="bg-black/60 backdrop-blur-xl border-2 border-warrior/20 p-4 rounded-2xl shadow-2xl">
              <div className="text-2xl font-black text-white mb-2 uppercase tracking-wide text-right">
                {questTitle}
              </div>
              <div className="flex items-center justify-end gap-3">
                ...
                <div className="text-xl font-bold text-warrior tabular-nums">
          ...
          >
            <div className="bg-black/80 backdrop-blur-xl border-2 border-red-500/30 p-8 rounded-3xl shadow-[0_-20px_50px_rgba(255,0,0,0.1)]">
              <div className="flex justify-between items-end mb-4">
                <div>
                  <div className="text-5xl font-black text-white tracking-tight uppercase italic">
                    {bossName}
                  </div>
                </div>
