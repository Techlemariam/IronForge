...
const UltrathinkDashboard: React.FC<UltrathinkDashboardProps> = ({
  ...
  const debuffs = wellness
    ? TrainingMemoryManager.calculateDebuffs(wellness.sleepScore || 100, wellness.hrv || 50)
    : [];
        ...
        <div className="bg-[#1a1a1a] border border-[var(--color-gold-bright)]/50 rounded-lg p-4 flex items-center gap-4 animate-slide-up relative overflow-hidden">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="text-[var(--color-gold-bright)] font-bold text-lg">
                {upcomingRace.name}
              </span>
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                ...
                <div className="flex flex-col text-right">
                  ...
                  {displayTitan.appliedMultiplier && displayTitan.appliedMultiplier > 1.0 && (
              ...
              return (
                <div key={day.dayOffset} className="flex items-center gap-4 text-xs">
                  ...
                  >
                    ...
                    <JargonTooltip term="TSB">TSB</JargonTooltip>
                  </div>
                </div>
              );
            })}
