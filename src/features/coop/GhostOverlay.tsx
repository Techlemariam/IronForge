...
import type { GhostEvent } from '@/services/coop/CoOpService';
import { AnimatePresence, motion } from 'framer-motion';
import { Dumbbell, FlameKindling, Ghost, Zap } from 'lucide-react';
      ...
      <AnimatePresence>
        {visibleEvents.map((event, i) => (
          ...
          >
            ...
            {/* Damage */}
            {event.damage && (
              <span className="text-xs font-black text-red-400 ml-2">+{event.damage} DMG</span>
            )}
          </motion.div>
        ))}
      </AnimatePresence>
