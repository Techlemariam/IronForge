...
const EquipmentArmory: React.FC = () => {
  ...
  if (loading)
    return <div className="p-8 text-center text-forge-muted">Accessing Armory Database...</div>;
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
              ...
              <p className="text-sm text-forge-muted mt-1 max-w-xl">
                ...
                <span className="text-white">Freak Athlete Hyper Pro</span>. The Oracle will
                aggressively suggest 10-in-1 compatible variations (Nordics, GHDs, Reverse Hypers)
                whenever possible.
              </p>
            </div>
