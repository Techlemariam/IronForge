...
export const MigrationTool = () => {
  const [status, setStatus] = useState<"IDLE" | "MIGRATING" | "DONE" | "ERROR">(
    "IDLE",
  );
  ...
  return (
    <div className="p-6 bg-forge-900 border border-forge-border rounded-lg shadow-xl max-w-md w-full">
      ...
      <p className="text-forge-muted text-sm mb-6">
        Move your local data to the secure IronForge Vault (PostgreSQL). This
        ensures you can access your progress across devices.
      </p>
