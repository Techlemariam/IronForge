...
import { CheckCircle, Scale, Swords, Wind } from 'lucide-react';
...
export const ArchetypeSelector: React.FC<ArchetypeSelectorProps> = ({ initialArchetype }) => {
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-zinc-500 mt-1">{arch.description}</p>
                </div>
                {isActive && (
