      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3 bg-black/40 p-3 rounded-lg border border-white/5">
          ...
          <div>
            ...
            <div
              className={`text-sm font-bold ${isUnclaimed ? 'text-zinc-600 italic' : 'text-zinc-200'}`}
            >
        ...
        {activeContest ? (
          <div className="bg-red-950/20 border border-red-500/20 p-3 rounded-lg space-y-3">
            ...
            <div className="space-y-1">
              ...
              <Progress
                value={
                  (activeContest.attackerScore /
                    (activeContest.attackerScore + activeContest.defenderScore + 1)) *
                  100
                }
