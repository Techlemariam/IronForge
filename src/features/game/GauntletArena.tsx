...
export const GauntletArena: React.FC<GauntletArenaProps> = ({ userLevel, userFtp, onClose, currentWatts, currentHr }) => {
    // State
    ...
    const [rewards, setRewards] = useState<{ xp: number; gold: number; kinetic: number } | null>(null);
            ...
            <div className="relative w-full max-w-4xl h-[60vh] flex items-center justify-center">
                {status === 'ACTIVE' && enemy && (
                    ...
                    >
                        ...
                        <div className="mt-2 text-red-300">HP: {enemy.hp} / {enemy.maxHp}</div>
                    </motion.div>
                )}
