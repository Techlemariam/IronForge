        ...
        <div className="h-full bg-zinc-950 flex flex-col font-serif">
            ...
            <div className="p-6 border-b border-zinc-900 bg-[#0a0a0a] relative">
                ...
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h2 className="text-3xl font-black uppercase tracking-tighter text-zinc-200">The Grimoire</h2>
                </div>
                <p className="text-zinc-500 italic text-sm">Keeper of knowledge, slain foes, and ancient legends.</p>
                                        ...
                                        <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black via-black/90 to-transparent">
                                            {monster.isDiscovered ? (
                                                <>
                                                    ...
                                                    <p className="text-zinc-500 text-xs line-clamp-2 mt-1">{monster.description}</p>
                                                ...
                                                <div className="flex flex-col items-center text-center">
                                                    ...
                                                    <div className="text-zinc-600 text-[10px] uppercase tracking-widest mt-2">Undiscovered Entity</div>
                                                    <div className="text-zinc-800 text-[10px] mt-1">Requires Level {monster.levelReq}</div>
                                                </div>
                                            )}
                                        </div>
                                    </motion.div>
