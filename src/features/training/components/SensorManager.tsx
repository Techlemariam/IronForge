                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between p-4 bg-zinc-800 rounded-xl border border-zinc-700">
                                <div className="flex items-center gap-3">
                                    <Heart className={cn("w-6 h-6", hrStatus.connected ? "text-red-500 fill-red-500" : "text-zinc-500")} />
                                    <div>
                            ...
                            <div className="flex items-center justify-between p-4 bg-zinc-800 rounded-xl border border-zinc-700">
                                <div className="flex items-center gap-3">
                                    <Zap className={cn("w-6 h-6", powerStatus.connected ? "text-yellow-400 fill-yellow-400" : "text-zinc-500")} />
                                    <div>
