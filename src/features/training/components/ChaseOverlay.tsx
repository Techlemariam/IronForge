...
import { Footprints, Skull, Trophy, Zap } from 'lucide-react';
  ...
  React.useEffect(() => {
    if (dangerLevel > 0.8 && !chaseState.isCaught && !chaseState.hasEscaped) {
      const interval = setInterval(
        ...
        1000 * (1 - dangerLevel * 0.5)
      ); // Faster heartbeat as danger increases
          ...
          <div className="bg-black/80 backdrop-blur-sm border border-white/10 rounded-xl p-4 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-lg">{chaseState.chaser.name}</h3>
            ...
            <div className="space-y-2">
              ...
              <div className="h-6 bg-zinc-950/80 rounded-full overflow-hidden border border-zinc-800 relative shadow-inner">
                ...
                <motion.div
                  ...
                  transition={{ repeat: Number.POSITIVE_INFINITY, duration: 2 }} // Breathing effect
                >
                  {chaseState.chaser.image}
                </motion.div>
            ...
            <div className="mt-3 flex justify-center gap-6 text-center">
              <div>
                ...
                <p
                  className={cn(
                    'text-xs font-mono',
                    paceDelta >= 0 ? 'text-green-500' : 'text-red-500'
                  )}
                >
                  {paceDelta >= 0 ? '+' : ''}
                  {paceDelta.toFixed(1)}
        ...
        {chaseState.hasEscaped && (
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-green-200 mb-6">You outran {chaseState.chaser.name}!</p>
              <button
        ...
        {chaseState.isCaught && (
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-red-200 mb-6">{chaseState.chaser.name} has caught up!</p>
              <button
