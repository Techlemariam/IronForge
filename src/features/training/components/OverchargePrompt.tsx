...
const OverchargePrompt: React.FC<OverchargePromptProps> = ({ onAccept, onDecline, suggestedWeight }) => {
    return (
        <motion.div
        ...
        >
            <div className="bg-zinc-900/95 border-2 border-yellow-500 rounded-xl p-4 shadow-[0_0_30px_rgba(234,179,8,0.3)] backdrop-blur-md">
                ...
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        <h3 className="text-yellow-400 font-bold uppercase tracking-widest text-sm">Opportunity Detected</h3>
