    ...
    return (
        <div className="bg-zinc-900 border border-white/5 rounded-xl p-6 max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
                <div>
                    <label className="block text-xs font-bold text-zinc-500 uppercase mb-1">Program Name</label>
                    <input
                        value={name}
                ...
                <div>
                    <label className="block text-xs font-bold text-zinc-500 uppercase mb-1">Duration (Weeks)</label>
                ...
                <div className="pt-4 border-t border-white/5">
                    ...
                    >
                        {isCreating ? 'Creating...' : <><Save className="w-4 h-4" /> Create Program</>}
                    </button>
                </div>
            </div>
        </div>
