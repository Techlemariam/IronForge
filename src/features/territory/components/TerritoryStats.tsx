...
import { Coins, Map, Shield, TrendingUp } from 'lucide-react';
import type React from 'react';
import type { TerritoryStatsData } from '../types';
...
const StatCard: React.FC<StatCardProps> = ({ title, value, icon, description, highlight }) => (
  <Card
    className={`bg-black/60 backdrop-blur-md border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 ${highlight ? 'ring-1 ring-emerald-500/50 bg-emerald-500/5' : ''}`}
  >
