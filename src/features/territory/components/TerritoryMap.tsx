      ...
      map.current?.addLayer({
        ...
        paint: {
          'fill-color': [
            ...
            TILE_COLORS.HOSTILE,
            'CONTESTED',
            TILE_COLORS.CONTESTED,
            'HOME_ZONE',
            TILE_COLORS.HOME_ZONE,
            TILE_COLORS.NEUTRAL,
          ],
          'fill-opacity': 0.5,
  ...
  return (
    <div className="relative w-full h-[600px] rounded-xl overflow-hidden shadow-2xl border-2 border-emerald-500/10">
      ...
      <div className="absolute bottom-6 left-6 bg-black/90 backdrop-blur-xl p-4 rounded-xl border border-white/5 text-xs text-white z-10 shadow-2xl">
        <h4 className="font-black mb-3 uppercase tracking-tighter text-emerald-400 text-sm">
          Zone Intel
        </h4>
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            <div
              className="w-4 h-4 rounded-sm shadow-[0_0_8px_rgba(16,185,129,0.3)]"
              style={{ backgroundColor: TILE_COLORS.OWNED }}
            />
            <span className="font-medium text-zinc-300">Imperial Domain</span>
          </div>
          <div className="flex items-center gap-3">
            <div
              className="w-4 h-4 rounded-sm shadow-[0_0_8px_rgba(59,130,246,0.3)]"
              style={{ backgroundColor: TILE_COLORS.HOME_ZONE }}
            />
            <span className="font-medium text-zinc-300">Titan&apos;s Sanctuary</span>
          </div>
          <div className="flex items-center gap-3">
            <div
              className="w-4 h-4 rounded-sm shadow-[0_0_8px_rgba(245,158,11,0.3)]"
              style={{ backgroundColor: TILE_COLORS.CONTESTED }}
            />
            <span className="font-medium text-zinc-300">Contested Flux</span>
          </div>
          <div className="flex items-center gap-3">
            <div
              className="w-4 h-4 rounded-sm shadow-[0_0_8px_rgba(239,68,68,0.3)]"
              style={{ backgroundColor: TILE_COLORS.HOSTILE }}
            />
