...
const PlateVisualizer: React.FC<PlateVisualizerProps> = ({
  weight,
  ...
  const getPlateColor = (p: number) => {
    switch (p) {
      case 25:
        return "bg-red-600 h-24 border-red-800";
      case 20:
        return "bg-blue-600 h-24 border-blue-800";
      case 15:
        return "bg-yellow-500 h-20 border-yellow-700";
      case 10:
        return "bg-green-600 h-16 border-green-800";
      case 5:
        return "bg-white h-12 border-zinc-400";
      case 2.5:
        return "bg-zinc-800 h-10 border-zinc-600";
      default:
        return "bg-zinc-500 h-8 border-zinc-700";
    }
  };
    ...
    <div className="flex flex-col items-center p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg mt-2">
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="flex items-center gap-px bg-zinc-800 px-1 py-4 rounded shadow-inner">
          {plates.length === 0 && (
            <span className="text-zinc-600 text-xs px-2">Empty Bar</span>
          )}
