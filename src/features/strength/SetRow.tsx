...
export const SetRow: React.FC<SetRowProps> = ({ index, set, onChange, onDelete, onComplete }) => {
    ...
    return (
        <div className={`grid grid-cols-12 gap-2 items-center p-2 rounded-md transition-colors ${set.completedAt ? 'bg-green-500/10' : 'bg-black/20'}`}>
