          ...
          return (
            ...
            >
              <div className="flex items-center gap-4">
                <div
                  className={`text-2xl font-black italic ${rankColor} w-8 text-center`}
                >
                  {index + 1}
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h4
                      className={`font-bold text-lg ${isMe ? "text-blue-400" : "text-zinc-200"}`}
                    >
                  ...
                  <div className="flex items-center gap-3 text-xs text-zinc-500 font-mono">
                    <span className="flex items-center gap-1">
                      <Swords className="w-3 h-3" /> {player.wins} Wins
                    </span>
                    <span className="flex items-center gap-1">
                      <Skull className="w-3 h-3" /> Wilks:{" "}
                      {player.highestWilksScore.toFixed(2)}
                    </span>
                    {player.city && (
