...
export const MONSTERS: Monster[] = [
  {
    ...
    level: 1,
    description:
      "A massive golem formed from ancient bedrock. Resilient and slow.",
    image: "🗿",
    hp: 1000,
    maxHp: 1000,
    element: "Earth",
  ...
  },
  {
    ...
    level: 3,
    description:
      "A spectral guardian bound to the heavy chains of the old forge.",
    image: "👻",
    hp: 500,
    maxHp: 500,
    element: "Shadow",
  ...
  },
  {
    ...
    level: 7,
    description:
      "A winged predator that feeds on the kinetic energy of rapid-fire movements.",
    image: "🐲",
    hp: 5000,
    maxHp: 5000,
    element: "Lightning",
  ...
  },
  {
    ...
    level: 10,
    description:
      "The pulsating heart of the foundry. High temperature, high pressure, high stakes.",
    image: "☄️",
    hp: 15000,
    maxHp: 15000,
    element: "Fire",
...
export const ZONES: Zone[] = [
  {
    ...
    description:
      "The industrial heart of IronForge. Heavy weights and high heat.",
    requiredLevel: 1,
...
export const RECIPES: CraftingRecipe[] = [
  ...
  },
  {
    ...
    resultCount: 1,
    materials: [{ itemId: "item_flux", count: 3 }],
    goldCost: 50,
