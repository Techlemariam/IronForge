...
export const MOBILITY_LAYER_BONUSES: Record<LayerLevel, LayerBonuses> = {
  ...
  SILVER: { injuryRisk: -0.1, romBonus: 0.05, recoveryBoost: 0 },
  GOLD: { injuryRisk: -0.15, romBonus: 0.1, recoveryBoost: 0.05 },
};
...
export const RECOVERY_LAYER_BONUSES: Record<LayerLevel, LayerBonuses> = {
  ...
  SILVER: { injuryRisk: -0.05, romBonus: 0, recoveryBoost: 0.1 },
  GOLD: { injuryRisk: -0.1, romBonus: 0, recoveryBoost: 0.15 },
};
...
export const MACRO_CYCLE_THRESHOLDS = {
  ...
  // Debuff multipliers
  SLEEP_DEBUFF_MULTIPLIER: 0.8, // -20% capacity
