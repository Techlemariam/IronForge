...
export const MOBILITY_EXERCISES: MobilityExercise[] = [
  ...
  // === KNEE & QUAD ===
  {
    ...
    instructions:
      'Step forward letting back knee drive toward ground. Heel stays down. 10 each leg.',
 ...
 */
export function calculateSessionCost(exercises: { exerciseId: string; durationSecs: number }[]): {
  cns: number;
  muscular: number;
  metabolic: number;
} {
