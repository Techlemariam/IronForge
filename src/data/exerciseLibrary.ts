...
const EXERCISE_LIBRARY: Exercise[] = [
  ...
  },
  {
    ...
    equipment: 'DUMBBELL',
    difficulty: 'BEGINNER',
    instructions: ['Arms extended above chest', 'Lower in arc motion', 'Squeeze at top'],
  },
  {
    id: 'cable-crossover',
  ...
  },
  {
    ...
    difficulty: 'BEGINNER',
    instructions: ['Hands shoulder-width', 'Body straight', 'Lower chest to ground'],
  },
  {
    id: 'dips',
    name: 'Dips',
    ...
    equipment: 'BODYWEIGHT',
    difficulty: 'INTERMEDIATE',
    instructions: ['Lean forward for chest focus', 'Lower until elbows at 90 degrees'],
  },
  ...
  // BACK
  {
    ...
    equipment: 'BARBELL',
    difficulty: 'ADVANCED',
    instructions: ['Feet hip-width', 'Grip outside legs', 'Drive through heels', 'Lock out at top'],
  },
  {
    id: 'barbell-row',
    name: 'Barbell Row',
    ...
    equipment: 'BARBELL',
    difficulty: 'INTERMEDIATE',
    instructions: ['Hinge at hips', 'Pull to lower chest', 'Squeeze shoulder blades'],
  },
  {
    id: 'pull-up',
    name: 'Pull-Up',
    ...
    equipment: 'BODYWEIGHT',
    difficulty: 'INTERMEDIATE',
    instructions: ['Overhand grip', 'Pull chin above bar', 'Lower with control'],
  },
  {
    id: 'lat-pulldown',
    name: 'Lat Pulldown',
  ...
  // LEGS
  {
    ...
    equipment: 'BARBELL',
    difficulty: 'INTERMEDIATE',
    instructions: ['Bar on upper back', 'Feet shoulder-width', 'Squat to parallel', 'Drive up'],
  },
  {
    id: 'front-squat',
    name: 'Front Squat',
  ...
  },
  {
    ...
    equipment: 'DUMBBELL',
    difficulty: 'BEGINNER',
    instructions: ['Step forward', 'Lower until knee close to ground', 'Alternate legs'],
  },
  {
    id: 'calf-raise',
    name: 'Calf Raise',
...
export async function getExercisesAction(filters?: {
  ...
  if (filters?.muscle) {
    results = results.filter(
      (e) => e.primaryMuscle === filters.muscle || e.secondaryMuscles.includes(filters.muscle!)
    );
  }
 ...
 * Get exercise by ID.
 */
export async function getExerciseByIdAction(id: string): Promise<Exercise | null> {
 ...
 */
export async function getExercisesByMuscleAction(muscle: MuscleGroup): Promise<Exercise[]> {
 ...
 */
export async function getRandomExerciseAction(muscle?: MuscleGroup): Promise<Exercise> {
  const pool = muscle
