      ...
      },
      {
        ...
        exercises: [
          ...
          },
          {
            ...
            demoUrl:
              "https://www.youtube.com/results?search_query=dumbbell+pullover+on+ghd",
            sets: [
...
export const SKILL_TREE: SkillNode[] = [
  ...
  },
  {
    ...
    title: "Piston Power",
    description:
      'Hip drive efficiency increased. Unlocks "Hip Thrust" alternate block.',
    category: "strength",
    parents: ["legs_1"],
    x: 0,
    y: 300,
  ...
  },
  {
    ...
    title: "Quadzilla",
    description:
      "Legs of a Titan. Belt Squat setup time reduced by 20% (Mental buff).",
    category: "strength",
    parents: ["legs_2"],
    x: 0,
    y: 450,
  ...
  },
  {
    ...
    title: "Heavy Metal",
    description:
      'Unlocks "Joker Sets" logic. Auto-regulates weight up if RPE < 7.',
    category: "strength",
    parents: ["beast_1"],
    x: 300,
    y: -300,
  ...
  },
  {
    ...
    title: "Apex Predator",
    description:
      'Daily 1RM inputs no longer require a warmup set confirmation. "Ready on arrival".',
    category: "strength",
    parents: ["beast_2"],
    x: 450,
    y: -450,
  ...
  },
  {
    ...
    description:
      "Plate Visualizer highlights change-plates automatically for micro-loading.",
    category: "utility",
    parents: ["eng_1"],
    x: 300,
    y: 300,
...
export const ACHIEVEMENTS: Achievement[] = [
  // --- GENERAL ---
  {
    ...
    description:
      "Sleep is for the weak. Complete a workout with Sleep Score < 40.",
    category: "general",
    points: 1,
  },
  {
  ...
  },
  {
    ...
    description:
      "No weak back allowed. Complete 3 sets of heavy GHD Raises or Back Extensions.",
    category: "dungeons",
    points: 5,
  },
  {
    ...
    title: "Krol Blade",
    description:
      'Build a back worthy of a raid boss. Complete "Heavy Pull" block with RPE 9.',
    category: "dungeons",
    points: 5,
  },
  ...
  },
  {
    ...
    description:
      "Load the Landmine Press with over 100kg using perfectly symmetrical plate math (no fractional plates).",
    category: "professions",
    points: 5,
  },
  ...
  // --- CARDIO / ENDURANCE (Elite Physics) ---
  {
    ...
    description:
      "Set a 20min Power PR (FTP) on the Wahoo KICKR while Body Battery < 50.",
    category: "cardio",
  ...
  // Brick Workout Achievements (Windrunner Gate)
  {
    ...
    title: "Brick Layer",
    description:
      "Complete a Brick Session: Heavy Squats followed immediately by 10min Z3 Run.",
    category: "cardio",
    points: 30,
  },
  {
    ...
    description:
      'Complete a "Double Brick": Bike -> Run -> Bike -> Run (Transition < 2min).',
    category: "cardio",
    points: 60,
  },
  {
