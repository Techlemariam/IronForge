...
export const EXERCISE_DB: Record<string, ExerciseAttributes> = {
  ...
  'Clean and Press': {
    muscle: 'full_body',
    secondaryMuscles: ['triceps', 'shoulders', 'glutes', 'quadriceps'],
    cnsTier: 9,
  },
  'Clean Pull': {
    muscle: 'full_body',
  ...
  'Deadlift (Band)': {
    muscle: 'glutes',
    secondaryMuscles: ['hamstrings', 'lower_back', 'forearms', 'traps'],
    cnsTier: 9,
  },
  'Deadlift (Barbell)': {
    muscle: 'glutes',
  ...
  'Deadlift High Pull': {
    muscle: 'full_body',
    secondaryMuscles: ['lower_back', 'hamstrings', 'glutes', 'forearms', 'traps'],
    cnsTier: 9,
  },
  ...
  'Landmine Squat and Press': {
    muscle: 'full_body',
    secondaryMuscles: ['glutes', 'hamstrings', 'lower_back', 'triceps'],
    cnsTier: 9,
  },
  'Lateral Band Walks': {
    muscle: 'glutes',
  ...
  'Romanian Deadlift (Barbell)': {
    muscle: 'hamstrings',
    secondaryMuscles: ['glutes', 'lower_back', 'forearms', 'traps'],
    cnsTier: 9,
  },
  ...
  'Squat Row': {
    muscle: 'full_body',
    secondaryMuscles: ['glutes', 'hamstrings', 'lower_back', 'biceps', 'shoulders'],
    cnsTier: 9,
  },
  'Squat (Smith Machine)': {
    muscle: 'quadriceps',
