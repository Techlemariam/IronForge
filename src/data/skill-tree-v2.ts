...
const JUGGERNAUT_NOTABLES: SkillNodeV2[] = [
    {
        ...
        cost: 1,
        requirements: [
            { type: '1rm_weight', exerciseId: 'ex_landmine_press', value: 30, comparison: 'gte' },
        ],
    },
    {
        ...
        cost: 2,
        requirements: [
            { type: '1rm_weight', exerciseId: 'ex_landmine_press', value: 50, comparison: 'gte' },
        ],
    },
    {
        id: 'notable_apex_predator',
        title: 'Apex Predator',
        description: 'Daily 1RM inputs no longer require warmup confirmation. Ready on arrival.',
        tier: 'notable',
        path: 'juggernaut',
        category: 'strength',
        ...
        cost: 4,
        requirements: [
            { type: 'achievement_count', exerciseId: 'any', value: 10, comparison: 'gte' },
        ],
    },
];
...
const ENGINE_NOTABLES: SkillNodeV2[] = [
    {
        ...
        cost: 500,
        requirements: [
            { type: 'achievement_count', exerciseId: 'any', value: 2, comparison: 'gte' },
        ],
    },
    {
        ...
        cost: 1500,
        requirements: [
            { type: 'achievement_count', exerciseId: 'any', value: 6, comparison: 'gte' },
        ],
    },
    {
...
const WARDEN_NOTABLES: SkillNodeV2[] = [
    {
        ...
        title: 'The Hybrid',
        description: 'Embrace dual training. +5% to both TP and KS from any session.',
        tier: 'notable',
        path: 'warden',
        category: 'hybrid',
        ...
        cost: 1,
        requirements: [
            { type: 'session_count', exerciseId: 'hybrid', value: 1, comparison: 'gte' },
        ],
    },
    {
        ...
        cost: 2,
        requirements: [
            { type: 'session_count', exerciseId: 'hybrid', value: 5, comparison: 'gte' },
        ],
    },
    {
        ...
        cost: 3,
        requirements: [
            { type: 'brick_workout_count', exerciseId: 'any', value: 1, comparison: 'gte' },
        ],
    },
];
...
const TITAN_NOTABLES: SkillNodeV2[] = [
    ...
    },
    {
        ...
        title: 'Pump Chaser',
        description: '+15% Titan Load from 10+ rep sets. Visual pump indicator in UI.',
        tier: 'notable',
        path: 'titan',
        category: 'hypertrophy',
    ...
    },
    {
        ...
        cost: 3,
        requirements: [
            { type: '1rm_weight', exerciseId: 'ex_belt_squat', value: 100, comparison: 'gte' },
...
const SAGE_NOTABLES: SkillNodeV2[] = [
    {
        ...
        cost: 1,
        requirements: [
            { type: 'rest_day_count', exerciseId: 'any', value: 7, comparison: 'gte' },
        ],
    },
    {
        id: 'notable_sleep_master',
        title: 'Sleep Master',
        description: '+50 KS per night with Sleep Score > 80. Sleep tracking widget.',
        tier: 'notable',
        path: 'sage',
        category: 'utility',
        ...
        cost: 2,
        requirements: [
            { type: 'sleep_score_streak', exerciseId: 'any', value: 14, comparison: 'gte' },
        ],
    },
    {
        ...
        requirements: [
            ...
            { type: 'rest_day_count', exerciseId: 'any', value: 30, comparison: 'gte' },
        ],
    },
];
