...
import type { SkillNodeV2, TitanRank } from '../types/skills';
...
const PATHFINDER_NOTABLES: SkillNodeV2[] = [
  ...
  },
  {
    ...
    currency: 'kinetic_shard',
    cost: 5000,
    requirements: [{ type: 'vo2max_value', exerciseId: 'any', value: 50, comparison: 'gte' }],
  },
  {
    ...
    currency: 'kinetic_shard',
    cost: 10000,
    requirements: [{ type: 'vo2max_value', exerciseId: 'any', value: 60, comparison: 'gte' }],
  },
];
...
const TITAN_NOTABLES: SkillNodeV2[] = [
  {
    ...
    currency: 'talent_point',
    cost: 1,
    requirements: [{ type: 'rep_count', exerciseId: 'any', value: 50, comparison: 'gte' }],
  },
  {
    ...
    currency: 'talent_point',
    cost: 2,
    requirements: [{ type: 'rep_count', exerciseId: 'any', value: 100, comparison: 'gte' }],
  },
  {
...
export const TITAN_RANKS: TitanRank[] = [
  { id: 1, name: 'Novice Titan', minTp: 5, minKs: 500 },
  {
    ...
    minTp: 15,
    minKs: 1500,
    gateDescription: 'Unlock 1 Achievement in Dungeons, Professions, and Cardio.',
  },
  {
    id: 3,
    name: 'Warrior Titan',
...
export function countUnlockedNotables(unlockedIds: Set<string>): number {
  return SKILL_TREE_V2.filter((node) => node.tier === 'notable' && unlockedIds.has(node.id)).length;
}
