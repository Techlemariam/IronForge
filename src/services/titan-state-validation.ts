...
export const TitanNameSchema = z.string()
...
export const StatsChangeSchema = z.object({
...
export const EconomyChangeSchema = z.object({
...
export function validateMutation<T>(schema: z.ZodSchema<T>, data: unknown): { valid: true; data: T } | { valid: false; errors: string[] } {
