 ...
 */
export const getSocialFeedAction = authActionClient
  .schema(z.object({
 ...
 */
export const commentOnFeedItemAction = authActionClient
  .schema(z.object({
    feedItemId: z.string(),
 ...
 */
export const shareWorkoutToFeedAction = authActionClient
  .schema(z.object({
    workoutId: z.string(),
