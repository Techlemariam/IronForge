...
const WEIGHT_CLASSES = ['59kg', '66kg', '74kg', '83kg', '93kg', '105kg', '120kg', '120kg+'];
 ...
 */
export async function getActiveTournamentsAction(): Promise<TournamentBracket[]> {
...
export function generateBracket(
  ...
  const sorted = [...participants].sort((a, b) => b.qualifyingLift - a.qualifyingLift);
