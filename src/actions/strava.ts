...
import { StravaTokenResponse, StravaActivity, mapStravaActivityToCardioLog } from '@/lib/strava';
...
export async function exchangeStravaTokenAction(code: string) {
    ...
    if (!STRAVA_CLIENT_ID || !STRAVA_CLIENT_SECRET) {
        return { success: false, error: 'Strava credentials not configured on server' };
    }
