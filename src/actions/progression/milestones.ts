 ...
 */
export async function getMilestonesAction(_userId: string): Promise<Milestone[]> {
  return MILESTONES;
}
 ...
 */
export async function getUnclaimedMilestonesAction(_userId: string): Promise<Milestone[]> {
