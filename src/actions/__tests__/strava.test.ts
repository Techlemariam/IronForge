...
import { getStravaAuthUrlAction, exchangeStravaTokenAction, syncStravaActivitiesAction, disconnectStravaAction } from '../strava';
...
describe('Strava Server Actions', () => {
    ...
    describe('getStravaAuthUrlAction', () => {
        it('should generate a valid auth URL', async () => {
            ...
            expect(url).toContain('redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fsettings');
    ...
    describe('syncStravaActivitiesAction', () => {
        ...
        it('should refresh token if expired', async () => {
            ...
            expect(axios.get).toHaveBeenCalledWith(expect.stringContaining('activities'), expect.objectContaining({
