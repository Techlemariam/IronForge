...
export type { HyperProTaxonomy, HyperProPattern, HyperProLoadingStyle, FrictionLevel } from './hyperpro';
...
import type { HyperProTaxonomy, HyperProPattern, HyperProLoadingStyle, FrictionLevel } from './hyperpro';
...
export interface Set {
  ...
  completed: boolean;
  isPrZone?: boolean;
  isPr?: boolean; // Added for tracking PRs in session
