...
import { MuscleGroupVolume, WeaknessLevel, RPVolumeStandards } from '../../types/auditor';
...
describe('Weakness Auditor Engine', () => {
    it('WA-01: Detects UNDERTRAINED status', () => {
        ...
        const chestAudit = report.muscleAudits.find(a => a.muscleGroup === 'Chest');
    ...
    it('WA-02: Detects OVERREACHED status', () => {
        ...
        const deltAudit = report.muscleAudits.find(a => a.muscleGroup === 'Shoulders (Side)');
