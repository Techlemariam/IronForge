 ...
 */
export async function calculateFatigueDebuff(userId: string): Promise<FatigueDebuff> {
    try {
 ...
 */
export function applyFatigueToDamage(baseDamage: number, debuff: FatigueDebuff): number {
 ...
 */
export function applyFatigueToAccuracy(baseAccuracy: number, debuff: FatigueDebuff): number {
 ...
 */
export function applyFatigueToCritChance(baseCrit: number, debuff: FatigueDebuff): number {
