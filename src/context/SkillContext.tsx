...
import { SKILL_TREE_V2, getNodeById, countUnlockedNotables } from '../data/skill-tree-v2';
import { SkillNodeV2, CalculatedEffects, SkillStatus, SkillRequirement } from '../types/skills';
import { calculateTitanRank, playSound, getMaxTM } from '../utils';
import { IntervalsWellness } from '../types';
import { StorageService } from '../services/storage';
import { useSkillEffects, canPurchaseKeystone, getPathProgress, SessionMetadata } from '../hooks/useSkillEffects';

// ============================================================================
// Logic Helpers
// ============================================================================

const checkRequirement = (req: SkillRequirement, unlockedAchievementIds: Set<string>, wellness: IntervalsWellness | null): boolean => {
...
export const SkillProvider: React.FC<SkillProviderProps> = ({
  ...
  // ─────────────────────────────────────────────────────────────────────────
  const calculatedEffects = useSkillEffects(purchasedSkillIds, wellness, sessionMetadata);
