...
export default function PrivacyPolicyPage() {
    return (
        <main className="min-h-screen bg-zinc-950 text-zinc-100 p-8 max-w-3xl mx-auto">
            ...
            <p className="text-sm text-zinc-400 mb-8">Last updated: December 24, 2025</p>

            <section className="mb-8">
                <h2 className="text-xl font-semibold mb-3">1. Information We Collect</h2>
                <p className="text-zinc-300 leading-relaxed">
                    IronForge collects the following information to provide our fitness gamification service:
                </p>
                <ul className="list-disc list-inside mt-2 text-zinc-300 space-y-1">
                    <li>Email address (for account authentication)</li>
                    <li>Workout data synced from third-party services (Hevy, Intervals.icu)</li>
            ...
            <section className="mb-8">
                ...
                <p className="text-zinc-300 leading-relaxed">
                    We use your information solely to provide the IronForge service, including:
                </p>
                <ul className="list-disc list-inside mt-2 text-zinc-300 space-y-1">
                    <li>Syncing and displaying your workout data</li>
                    <li>Calculating XP, levels, and in-game rewards</li>
                    <li>Providing personalized training recommendations via our AI Oracle</li>
                </ul>
            </section>
            ...
            <section className="mb-8">
                <h2 className="text-xl font-semibold mb-3">4. Data Retention & Deletion</h2>
                <p className="text-zinc-300 leading-relaxed">
                    You can delete your account and all associated data at any time from the Settings menu
                    within the app. Upon deletion, all your data is permanently removed from our systems.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="text-zinc-300 leading-relaxed">
                    ...
                    <a href="mailto:privacy@ironforge.app" className="text-orange-400 hover:underline">
