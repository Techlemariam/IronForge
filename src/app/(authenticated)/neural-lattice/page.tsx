      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-steel max-w-2xl mt-1">
            Allocate Talent Points (TP) earned from athletic volume and Kinetic Shards (KS)
            accumulated from recovery. Choose your path wisely, as Keystones demand physical
            sacrifice in exchange for power.
          </p>
        </div>
      </div>
