...
import { Info, Map as MapIcon, Shield, Sword } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex gap-4">
            <div className="bg-zinc-900/50 border border-white/5 rounded-xl px-5 py-3 flex items-center gap-4">
              ...
              <div
                className={`w-2 h-2 rounded-full ${dbUser.guildId ? 'bg-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.5)]' : 'bg-zinc-700'}`}
              />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-zinc-900/30 border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-white/10 transition-all">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
              Unclaimed territories can be captured instantly by any guild. Control grants immediate
              resource bonuses to all members.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/30 border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-white/10 transition-all">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
              Issuing a challenge starts a 7-day siege. The guild with the highest accumulated
              training volume (kg) at the end of the week wins control.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/30 border border-white/5 rounded-2xl p-6 relative overflow-hidden group hover:border-white/10 transition-all">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
              Every rep counts. Volume from Strava, Hevy, and Apple Watch syncs directly to active
              contests your guild is involved in.
            </p>
          </div>
        </div>
      </div>
