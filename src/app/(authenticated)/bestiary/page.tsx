  ...
  return (
    <div className="min-h-screen bg-forge-950 text-white p-6 md:p-12 pb-24">
      ...
      <div className="max-w-7xl mx-auto mb-12 relative">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 py-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-4xl font-serif tracking-widest text-shadow-glow uppercase text-red-100">
                The Bestiary
              </h1>
              <p className="text-forge-muted font-mono text-sm tracking-wide">
                Known Threats & Bosses
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto">
        <Suspense
          fallback={
            <div className="text-center font-mono animate-pulse text-red-500">
              Scanning Perimeter...
            </div>
          }
        >
