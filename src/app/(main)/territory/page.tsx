...
} from '@/actions/systems/territory';
      ...
      <Tabs defaultValue="map" className="w-full">
        ...
        <TabsContent value="map" className="space-y-4">
          ...
          <div className="bg-emerald-500/10 p-4 rounded-lg border border-emerald-500/20 text-sm text-emerald-300">
            <p>
              <strong>Pro Tip:</strong> Tiles in your 500m Home Zone are immune to control loss and
              generate more gold!
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="leaderboard">
          <TerritoryLeaderboard users={leaderboards} guilds={guildLeaderboards} />
        </TabsContent>
      </Tabs>
    </div>
  );
