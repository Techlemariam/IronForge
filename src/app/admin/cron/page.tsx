...
import { GameToaster, toast } from '@/components/ui/GameToast';
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              ...
              <CardContent className="space-y-4">
                <p className="text-sm text-zinc-400">
                  Recalculates Titan power ratings, strength/cardio indices, and applies inactivity
                  decay.
                </p>
                <Button
          ...
          <div className="bg-amber-950/20 border border-amber-900/50 p-4 rounded-lg flex gap-3">
            ...
            <div className="text-xs text-amber-200/70">
              ...
              Triggering these manually will affect production data. Use with caution. Authorization
              relies on NEXT_PUBLIC_CRON_SECRET in this interface.
            </div>
          </div>
        </div>
      </div>
