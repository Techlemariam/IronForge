...
import { Activity, LayoutDashboard, Mic2, Wrench } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-slate-800/60">
          <div className="space-y-1">
            ...
            <p className="text-slate-400 max-w-2xl">
              Real-time intelligence and execution monitoring for the IronForge Feature Assembly
              Line.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="p-6 rounded-2xl border border-slate-800 bg-slate-900/40 backdrop-blur-sm flex items-center justify-between">
            ...
            <div className="flex -space-x-2">
              <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-indigo-500 flex items-center justify-center text-[10px] font-bold">
                D
              </div>
              <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-red-500 flex items-center justify-center text-[10px] font-bold">
                N
              </div>
            </div>
          </div>
