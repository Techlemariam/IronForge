...
import { ArrowRight, Brain, Swords, Activity, Zap, Shield, Crown } from 'lucide-react'
        ...
        <div className="min-h-screen bg-forge-950 text-white overflow-x-hidden selection:bg-warrior selection:text-black">
            ...
            <nav className="fixed top-0 w-full z-50 bg-forge-950/80 backdrop-blur-md border-b border-white/5">
                <div className="container mx-auto px-6 h-16 flex items-center justify-between">
                    ...
                    <div>
                        <Link href="/login" className="text-sm font-mono uppercase tracking-widest text-forge-muted hover:text-white transition-colors mr-6">
                            Log In
                        </Link>
                        <Link href="/login" className="bg-white text-black px-5 py-2 rounded font-bold text-sm uppercase tracking-wide hover:bg-warrior hover:scale-105 transition-all">
                            Join the Faction
                        </Link>
                    </div>
                </div>
                ...
                <div className="container mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-5xl lg:text-7xl font-black mb-6 tracking-tight leading-tight">
                            Forge Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-warrior to-orange-500">Legacy</span><br />
                            Not Just A Body.
                        </h1>
                        <p className="text-xl text-forge-muted max-w-2xl mx-auto mb-10 leading-relaxed">
                            The first AI-augmented training platform that treats your fitness journey like a grand strategy RPG. Train, battle, and ascend.
                        </p>

                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link href="/login" className="w-full sm:w-auto px-8 py-4 bg-warrior text-black font-bold rounded text-lg flex items-center justify-center gap-2 hover:bg-warrior-light hover:shadow-[0_0_30px_rgba(255,215,0,0.3)] transition-all">
                                Begin Your Saga <ArrowRight className="w-5 h-5" />
                            </Link>
                            <Link href="/login" className="w-full sm:w-auto px-8 py-4 bg-white/5 border border-white/10 text-white font-bold rounded text-lg hover:bg-white/10 transition-all">
                                View Demo
                            </Link>
                        </div>
                    </motion.div>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold mb-3 text-white">The Oracle AI</h3>
                            <p className="text-forge-muted leading-relaxed">
                                An adaptive intelligence that analyzes your HRV, sleep, and performance to generate the perfect daily workout.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold mb-3 text-white">PvP & Boss Battles</h3>
                            <p className="text-forge-muted leading-relaxed">
                                Join a faction. Battle raid bosses with your squad. Your physical effort deals real damage in the digital realm.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold mb-3 text-white">Neural Lattice</h3>
                            <p className="text-forge-muted leading-relaxed">
                                A visualized skill tree of your physical capabilities. Unlock perks and abilities as you master different domains.
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <div className="text-xs uppercase tracking-widest text-forge-muted">Active Titans</div>
                        </div>
                        <div>
                            <div className="text-4xl font-black text-white mb-2">84k</div>
                            <div className="text-xs uppercase tracking-widest text-forge-muted">Kgs Lifted</div>
                        </div>
                        <div>
                            <div className="text-4xl font-black text-white mb-2">14</div>
                            <div className="text-xs uppercase tracking-widest text-forge-muted">Bosses Slain</div>
                        </div>
                        <div>
                            <div className="text-4xl font-black text-white mb-2">99%</div>
                            <div className="text-xs uppercase tracking-widest text-forge-muted">Uptime</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <footer className="py-12 border-t border-white/5 text-center text-forge-muted text-sm">
                <p>&copy; {new Date().getFullYear()} IronForge. All rights reserved.</p>
