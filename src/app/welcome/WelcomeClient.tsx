...
import { Activity, ArrowRight, Brain, Swords, Zap } from 'lucide-react';
    ...
    <main className="min-h-screen bg-forge-950 text-white overflow-x-hidden selection:bg-warrior selection:text-black">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-forge-muted max-w-2xl mx-auto mb-10 leading-relaxed">
              The first AI-augmented training platform that treats your fitness journey like a grand
              strategy RPG. Train, battle, and ascend.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h2 className="text-xl font-bold mb-3 text-white">The Oracle AI</h2>
              <p className="text-forge-muted leading-relaxed">
                An adaptive intelligence that analyzes your HRV, sleep, and performance to generate
            ...
            >
              ...
              <h2 className="text-xl font-bold mb-3 text-white">PvP & Boss Battles</h2>
              <p className="text-forge-muted leading-relaxed">
                Join a faction. Battle raid bosses with your squad. Your physical effort deals real
                damage in the digital realm.
              </p>
            </motion.div>
            ...
            >
              ...
              <h2 className="text-xl font-bold mb-3 text-white">Neural Lattice</h2>
              <p className="text-forge-muted leading-relaxed">
                A visualized skill tree of your physical capabilities. Unlock perks and abilities as
                you master different domains.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 border-y border-white/5">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-16 underline decoration-warrior/30 underline-offset-8">
