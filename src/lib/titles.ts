...
export const DEFINED_TITLES = [
    { id: 'gladiator', name: "Gladiator", conditionType: "PVP_RANK", conditionValue: 1200, description: "Reach 1200 Rating" },
    { id: 'warlord', name: "Warlord", conditionType: "PVP_RANK", conditionValue: 1500, description: "Reach 1500 Rating" },
    { id: 'high_warlord', name: "High Warlord", conditionType: "PVP_RANK", conditionValue: 2000, description: "Reach 2000 Rating" },
    { id: 'iron_born', name: "Iron Born", conditionType: "MINING", conditionValue: 100, description: "Mine 100 Ore" }, // Future example
];
...
export async function checkAndGrantTitles(userId: string) {
    ...
    const unownedTitles = DEFINED_TITLES.filter(def =>
        !user.titles.some(t => t.title.name === def.name)
    );
