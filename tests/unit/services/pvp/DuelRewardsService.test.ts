...
import type { PlayerContext } from '@/types/game';
...
describe('DuelRewardsService', () => {
  ...
  it('should calculate base rewards for a winner', async () => {
    // Arrange
    vi.mocked(GameContextService.getPlayerContext).mockResolvedValue(
      mockBaseContext as PlayerContext
    );
