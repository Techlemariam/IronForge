...
describe('ProgressionService', () => {
  ...
  describe('calculateMultiplier', () => {
    it('should return base multiplier for high level user', () => {
      const mult = ProgressionService.calculateMultiplier(0, 'NEUTRAL', 'FREE', 'NEUTRAL', 50);
      expect(mult).toBe(1.0);
    });

    it('should apply apprentice boost for levels <= 10', () => {
      // Level 1
      const mult1 = ProgressionService.calculateMultiplier(0, 'NEUTRAL', 'FREE', 'NEUTRAL', 1);
      expect(mult1).toBe(1.5);

      // Level 10
      const mult10 = ProgressionService.calculateMultiplier(0, 'NEUTRAL', 'FREE', 'NEUTRAL', 10);
      expect(mult10).toBe(1.5);

      // Level 11
      const mult11 = ProgressionService.calculateMultiplier(0, 'NEUTRAL', 'FREE', 'NEUTRAL', 11);
    ...
    it('should stack streaks and subscriptions', () => {
      ...
      const mult = ProgressionService.calculateMultiplier(10, 'NEUTRAL', 'PRO', 'NEUTRAL', 1);
